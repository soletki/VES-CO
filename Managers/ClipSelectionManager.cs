...
namespace VESCO.Managers
{
    public class ClipSelectionManager
    {
        ...
        public ClipSelectionManager(TimelineController timelineController, ClipDrawManager clipDrawManager, TrackManager trackManager, Canvas timelineCanvas, TextBox xTextBox, TextBox yTextBox, TextBox scaleTextBox, TextBox opacityTextBox)
        {
